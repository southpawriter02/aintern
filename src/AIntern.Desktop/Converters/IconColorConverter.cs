...
public class IconColorConverter : IMultiValueConverter
{
    ...
    /// <summary>Folder icon color - warm gold.</summary>
    private static readonly Color FolderColor = Color.Parse("#E8A838");

    /// <summary>Default file icon color - neutral gray.</summary>
    private static readonly Color DefaultColor = Color.Parse("#8B8B8B");

    /// <summary>Language-specific icon colors based on official branding.</summary>
    private static readonly Dictionary<string, Color> IconColors = new()
    {
        ...
        ["file-typescript-react"] = Color.Parse("#3178C6"),
        ...
        // Code (generic)
        ["file-code"] = Color.Parse("#6D8086"),        // Generic code Gray-Blue
    };
    ...
    /// <summary>Gets the color for a specific icon key (for programmatic use).</summary>
    ...
    /// <summary>Gets all supported icon keys with colors.</summary>
